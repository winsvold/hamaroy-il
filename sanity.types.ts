...
// Source: src/app/(frontend)/components/NewsBanner.tsx
// Variable: bannerQuery
// Query: *[  _type == "message" &&  showInBanner == true &&  defined(bannerText) &&  (!defined(expiresAt) || expiresAt > now())] | order(publishedAt desc)[0] {  label,  bannerText,}
